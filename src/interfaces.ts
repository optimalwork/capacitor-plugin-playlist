...
export declare type PlaylistStatusChangeCallback = (
  data: PlaylistStatusChangeCallbackArg,
) => void;
...
export interface AudioPlayerCommands {
  /**
   * Determines if the togglePlayPause command is enabled.
   *
   * @defaultValue `true`
   */
  togglePlayPause?: boolean;
  /**
   * Determines if the skipBackward command is enabled and how much to skip backward by.
   *
   * @defaultValue `15`
   */
  skipBackward?: number;
  ...
  /**
   * Determines if the skipForward command is enabled and how much to skip forward by.
   *
   * @defaultValue `30`
   */
  skipForward?: number;
  ...
  /**
   * Determines if the changePlaybackPosition command is enabled.
   *
   * @defaultValue `true`
   */
  changePlaybackPosition?: boolean;

  /**
   * Determines if the nextTrack command is enabled.
   */
  nextTrack?: boolean;

  /**
   * Determines if the previousTrack command is enabled.
   */
  previousTrack?: boolean;
}
export interface NotificationOptions {
  icon?: string;
  commands?: AudioPlayerCommands;
}
/**
